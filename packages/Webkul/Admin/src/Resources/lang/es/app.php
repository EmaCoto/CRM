...
return [
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'telephony' => [
                    'title' => 'Telefonía',
                    'info' => 'Prepara integraciones de llamadas para tu equipo comercial.',
                    'zadarma' => [
                        'title' => 'Zadarma',
                        'info' => 'Guarda aquí las credenciales futuras de Zadarma. Solo los administradores deberían gestionar esta sección.',
                        'enabled' => 'Activar Zadarma',
                        'api-key' => 'API Key',
                        'source' => 'Origen del callback',
                        'source-info' => 'Teléfono, SIP, extensión PBX o escenario PBX usado como origen en las solicitudes callback de Zadarma.',
                        'api-secret' => 'API Secret',
                        'sip' => 'Extensión PBX / SIP',
                        'sip-info' => 'Extensión PBX o SIP opcional usada para marcar y aplicar su Caller ID o configuración de llamada.',
                        'predicted' => 'Usar callback predictivo',
                        'auto-sync-webhook' => 'Sincronizar webhook automáticamente',
                        'webhook-url' => 'URL pública del webhook',
                        'webhook-url-info' => 'URL pública opcional para eventos de llamadas de Zadarma. Si la dejas vacía se usará APP_URL cuando sea accesible públicamente.',
                    ],
                ],
            ],
            'email' => [
    ...
    'integrations' => [
        'zadarma' => [
            'call' => [
                'button' => 'Llamar',
                'confirm-title' => 'Confirmar llamada',
                'confirm-message' => 'Quieres llamar a',
                'confirm-message-phone' => 'Quieres llamar al número',
                'success' => 'La solicitud de llamada de Zadarma se registró correctamente.',
                'failed' => 'No se pudo iniciar la llamada de Zadarma.',
                'not-configured' => 'Zadarma todavía no está configurado. Pídele a un administrador que complete Configuración > Telefonía > Zadarma primero.',
                'activity-title' => 'Llamada Zadarma: :name',
                'activity-comment' => 'Se creó una solicitud de llamada desde el CRM hacia :phone para Zadarma.',
                'webhook-sync-warning' => 'La llamada se inició, pero no se pudo sincronizar automáticamente el webhook de Zadarma.',
                'activity-provider' => 'Proveedor',
                'activity-status' => 'Estado',
                'activity-duration' => 'Duración',
                'activity-source' => 'Origen',
